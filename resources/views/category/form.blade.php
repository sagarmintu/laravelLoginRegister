      ...
      <div class="col-12">
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ isset($category) ? 'Form Edit Category' : 'Form add Category' }}
            <a href="{{ url('/category') }}" class="btn btn-primary btn-sm" style="float: inline-end">Back</a>
            </h6>
          </div>
          <div class="card-body">

        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ isset($product) ? 'Form Edit product' : 'Form plus
                        product' }}
                    <a href="{{ url('/products') }}" class="btn btn-primary btn-sm" style="float: inline-end">Back</a>
                    </h6>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <label for="item_code">Add product</label>
